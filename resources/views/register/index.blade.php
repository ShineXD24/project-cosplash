...
<style>
  ...
  .right {
    right: 0;
    display: flex;
    background-image: url('/img/bochi.jpg');
    ...
    <div class="centered">
      <div class="form-signin w-100 p-500">
        <form method="POST" action="/register/create">
          ...
          <br>
          <div class="form-floating">
            <input type="email" value="{{ Session::get('email') }}" name="email" id="email" class="form-control" placeholder="namalu@example.com">
          ...
          <button class="btn w-100" class="btn" style="background-color: #7B93FF; color: white;" name="submit" type="submit">Login</button>
